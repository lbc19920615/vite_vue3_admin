...
export default function usePopover(props: IUsePopover, ctx: SetupContext<string[]>): {
    ...
    events: import("element-plus/es/components/popper/src/use-popper").PopperEvents;
    popperId: string;
    popperInstance: import("element-plus/es/components/popper").PopperInstance;
    popperRef: import("vue").Ref<HTMLElement>;
    triggerRef: import("vue").Ref<import("element-plus/es/components/popper/src/use-popper").ElementType>;
